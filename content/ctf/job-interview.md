...
In this case, when do `fls` to look for file system, we are left with a result `Unsupported image file type (Tar Archive)`. Why is a disk image archived? 
...
This [article](https://medium.com/@ronald.craft/blind-forensics-with-the-rdp-bitmap-cache-16e0c202f91c) introduces tools to work with bitmap cache, including[bmc-tools](https://github.com/ANSSI-FR/bmc-tools) by ANSSI-FR, the French National Agency for the Security of Information Systems, the French equivalent of the NSA. 
